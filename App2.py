...
"}")
        ...
        self.horizontalLayout_4.setContentsMargins(-1, -1, 0, 68)
        ...
        self.pushButton_5 = QtWidgets.QPushButton(self.top_btns)
...
"}")
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.bot_btns)
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_3 = QtWidgets.QPushButton(self.bot_btns)
        font = QtGui.QFont()
        font.setFamily("Montserrat SemiBold")
        font.setPointSize(10)
        font.setBold(True)
